...
class UserController extends Controller
{
    public function index()
    {
        ...
        $level = LevelModel::all(); //ambil data leval untuk filter level
  ...
  //js 5 prak 3(9)
    ...
    public function show(string $id)
    {
        ...
        $activeMenu = 'User'; //set mneu ynag sedang aktif
    ...
    {
        $request->validate([
            // username harus diisi, berupa string, minimal 3 karakter, dan bernilai unik di tabel m_user, kecuali user yang sedang diedit
